...
namespace WebApi.Controllers
{
    ...
    public class UserController : BaseApiController
    {
        ...
        public HttpResponseMessage CreateUser(Guid userId, [FromBody] UserModel model)
        {
            ...
            {
                return AlreadyExists("A user already exists with that specific userid: " + userId);
            }
        }
        ...
        public HttpResponseMessage UpdateUser(Guid userId, [FromBody] UserModel model)
        {
            ...
            if (string.IsNullOrEmpty(model.Name) || string.IsNullOrEmpty(model.Email) ||
                model.AnnualSalary == null)
            {
                return ValueCannotBeNull("Check that Name, Email, or AnnualSalary are not null or empty");
            }
